...
const Contact = () => {
  // SSR-safe rootElement for Calendly
  const rootElement = typeof window !== 'undefined' ? document.getElementById('root') : null;
  return (
    <section id="contact" className="w-full flex flex-col items-center justify-center gap-2 min-h-[80vh] bg-secondary text-primary" aria-labelledby="contact-heading">
      <h1 id="contact-heading" className="text-3xl mb-4 sm:mb-8">Contact Us</h1>
